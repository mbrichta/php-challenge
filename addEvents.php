            ...
            <?php
                ...
                if (isset($_POST['addEvent'])){
                    ...
                    if(!empty($away_team)){
                        ...
                        if($db->query($sql)){
                            echo "<p class='success-text'>*Event created succesfully</p>";
                        }
                        else {
                        ...
                        echo "<p class='failed-text'>*Please choose an Away Team...</p>";
                    }
                    }
                    else{
                        echo "<p class='failed-text'>*Please choose a Home Team...</p>";
                    }
                    }else {
                        echo "<p class='failed-text'>*Please enter the sport...</p>";
                        die();
                    }
                    }
                    else {
                        echo "<p class='failed-text'>*Please enter a League...</p>";
                        die();
                    }
                    }
                    else {
                        echo "<p class='failed-text'>*Please provide date and time...</p>";
                        die();
                    }
                }
